...
def crawlOnePage(dataset: IbsfDataSet, pageNumber: int):
    ...
    url = f"https://www.ibsf.org/en/athletes?tx_fmathletes_list%5Bgender%5D=&tx_fmathletes_list%5Bnation%5D=&tx_fmathletes_list%5Bpage%5D={pageNumber}&tx_fmathletes_list%5Bseason%5D=1000004&tx_fmathletes_list%5Bsport%5D=sn&tx_fmathletes_list%5Bsword%5Di"
